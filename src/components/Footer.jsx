...
function Footer() {
  return (
      <div className='w-full h-screen p-20 flex justify-between'> 
          <div className='w-1/2 font-bebas h-full flex flex-col justify-between '>
             <div className='heading'>
             <h1 className='text-9xl uppercase leading-none -mb-8 tracking-tighter'>Eye-</h1>
             <h1 className='text-9xl uppercase leading-none -mb-8 tracking-tighter'>Opening</h1>
             </div>
             <div>
          ...
          <div className="w-1/2">
          <h1 className='text-9xl font-bebas uppercase leading-none -mb-8 tracking-tighter'>
            Presentations
            
          </h1>
          <div className='dets font-ibm mt-10'>
                  <a className='block text-md underline font-light' href="#Facebook">Facebook</a>
                  <a className='block text-md underline font-light' href="#Instagram">Instagram</a>
                  <a className='block text-md underline font-light' href="#Twitter">Twitter</a> 
